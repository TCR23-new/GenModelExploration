...
class SwapVAE_ClfAux_PV(nn.Module):
    ...
    def forward(self,x,y):
        ...
        aux_out1 = self.aux_block(z1c)
        aux_out2 = self.aux_block(z2c)
        aux_loss = (self.aux_loss(aux_out1,y.reshape(-1,1).double()) + self.aux_loss(aux_out2,y.reshape(-1,1).double()))/2
